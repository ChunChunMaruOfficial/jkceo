...
export default function ({seconds, setsleeping, setisshield} : {seconds: number, setsleeping: React.Dispatch<React.SetStateAction<boolean>>, setisshield: React.Dispatch<React.SetStateAction<boolean>>}) {
